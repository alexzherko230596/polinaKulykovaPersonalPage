...
export const Header = (props) => {
    ...
    return(
        <header className={classes.header}>
            ...
            <nav className={isBurger ? classes.header__wrapperMobile__burgerMenu__rightBlock__menu__list : classes.header__wrapperMobile__burgerMenu__rightBlock__menu__list_hide}>
